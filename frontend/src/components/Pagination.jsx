...
export default function Pagination({
  pageNumber = 1,
  resultNumber = 10,
  totalPages = Math.floor(resultNumber / 8) + 1,
  onPageChange,
}) {
  const numbers = [];
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-16">
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">{resultNumber}</span> results
          </p>
        </div>
        <div>
          <nav
